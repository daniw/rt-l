...
einer solchen Regelung (die 2 Übertragungsfunktionen $P_1(s)$ und $P_2(s)$, 
die Laplace-Transformation der Referenzdrehzahl $\Omega_r(s)$ und die 
Übertragungsfunktion des Reglers $C(s)$ sollten in diesem Blockschaltbild 
ersichtlich sein).
\end{aufgabe}
\begin{figure}[h!]
    \centering
